...
class CoordinationV1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def deleteNamespacedLease(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/coordination.k8s.io/v1/namespaces/${namespace}/leases/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def listLeaseForAllNamespaces(
      ...
      apiKey: ApiKeyValue
    ): ApiRequestT[LeaseList] =
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/coordination.k8s.io/v1/leases?allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&pretty=$pretty&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  def listNamespacedLease(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/coordination.k8s.io/v1/namespaces/${namespace}/leases?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .response(asJson[LeaseList])
  ...
  def patchNamespacedLease(
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/coordination.k8s.io/v1/namespaces/${namespace}/leases/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
  ...
  def replaceNamespacedLease(
    ...
    basicRequest
      .method(Method.PUT,
              uri"$baseUrl/apis/coordination.k8s.io/v1/namespaces/${namespace}/leases/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager")
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
      .response(asJson[Lease])
