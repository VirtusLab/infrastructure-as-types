...
object ApiregistrationApi {
  ...
  def apply(baseUrl: String = "http://localhost") = new ApiregistrationApi(baseUrl)
}

class ApiregistrationApi(baseUrl: String) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIGroup](ApiMethods.GET, baseUrl, "/apis/apiregistration.k8s.io/", "application/json")
