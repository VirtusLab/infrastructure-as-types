...
class NetworkingV1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def deleteNamespacedNetworkPolicy(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/networking.k8s.io/v1/namespaces/${namespace}/networkpolicies/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def listNamespacedNetworkPolicy(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/networking.k8s.io/v1/namespaces/${namespace}/networkpolicies?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  def listNetworkPolicyForAllNamespaces(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/networking.k8s.io/v1/networkpolicies?allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&pretty=$pretty&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .response(asJson[NetworkPolicyList])
  ...
  def patchNamespacedNetworkPolicy(
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/networking.k8s.io/v1/namespaces/${namespace}/networkpolicies/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
  ...
  def replaceNamespacedNetworkPolicy(
    ...
    basicRequest
      .method(
        Method.PUT,
        uri"$baseUrl/apis/networking.k8s.io/v1/namespaces/${namespace}/networkpolicies/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
