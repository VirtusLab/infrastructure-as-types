...
case class V1PodSpec (
  ...
  hostAliases: Option[Seq[V1HostAlias]] = None,
  ...
  imagePullSecrets: Option[Seq[V1LocalObjectReference]] = None,
  ...
  initContainers: Option[Seq[V1Container]] = None,
  ...
  readinessGates: Option[Seq[V1PodReadinessGate]] = None,
  ...
  securityContext: Option[V1PodSecurityContext] = None,
  ...
  tolerations: Option[Seq[V1Toleration]] = None,
