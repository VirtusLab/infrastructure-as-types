...
class AutoscalingV1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def createNamespacedHorizontalPodAutoscaler(
    ...
    basicRequest
      .method(
        Method.POST,
        uri"$baseUrl/apis/autoscaling/v1/namespaces/${namespace}/horizontalpodautoscalers?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager"
      )
  ...
  def deleteNamespacedHorizontalPodAutoscaler(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/autoscaling/v1/namespaces/${namespace}/horizontalpodautoscalers/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def listHorizontalPodAutoscalerForAllNamespaces(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/autoscaling/v1/horizontalpodautoscalers?allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&pretty=$pretty&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  def listNamespacedHorizontalPodAutoscaler(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/autoscaling/v1/namespaces/${namespace}/horizontalpodautoscalers?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .response(asJson[HorizontalPodAutoscalerList])
  ...
  def patchNamespacedHorizontalPodAutoscaler(
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/autoscaling/v1/namespaces/${namespace}/horizontalpodautoscalers/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
  ...
  def patchNamespacedHorizontalPodAutoscalerStatus(
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/autoscaling/v1/namespaces/${namespace}/horizontalpodautoscalers/${name}/status?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
      .contentType("application/json-patch+json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def replaceNamespacedHorizontalPodAutoscaler(
    ...
    basicRequest
      .method(
        Method.PUT,
        uri"$baseUrl/apis/autoscaling/v1/namespaces/${namespace}/horizontalpodautoscalers/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def replaceNamespacedHorizontalPodAutoscalerStatus(
    ...
    basicRequest
      .method(
        Method.PUT,
        uri"$baseUrl/apis/autoscaling/v1/namespaces/${namespace}/horizontalpodautoscalers/${name}/status?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
