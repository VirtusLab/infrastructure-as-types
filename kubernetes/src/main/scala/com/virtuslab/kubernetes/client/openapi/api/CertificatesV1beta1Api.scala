...
class CertificatesV1beta1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def deleteCertificateSigningRequest(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  /**
    ...
    * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def listCertificateSigningRequest(
      pretty: Option[String] = None,
      allowWatchBookmarks: Option[Boolean] = None,
      continue: Option[String] = None,
      fieldSelector: Option[String] = None,
      ...
      apiKey: ApiKeyValue
    ): ApiRequestT[CertificateSigningRequestList] =
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/certificates.k8s.io/v1beta1/certificatesigningrequests?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  def patchCertificateSigningRequest(
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
  ...
  /**
    ...
    * @param body
    */
  def patchCertificateSigningRequestStatus(
      name: String,
      pretty: Option[String] = None,
      dryRun: Option[String] = None,
      fieldManager: Option[String] = None,
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/${name}/status?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
      .contentType("application/json-patch+json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  /**
    ...
    */
  def readCertificateSigningRequest(
      name: String,
      pretty: Option[String] = None,
  ...
  def replaceCertificateSigningRequestApproval(
    ...
    basicRequest
      .method(
        Method.PUT,
        uri"$baseUrl/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/${name}/approval?dryRun=$dryRun&fieldManager=$fieldManager&pretty=$pretty"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def replaceCertificateSigningRequestStatus(
    ...
    basicRequest
      .method(
        Method.PUT,
        uri"$baseUrl/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/${name}/status?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
