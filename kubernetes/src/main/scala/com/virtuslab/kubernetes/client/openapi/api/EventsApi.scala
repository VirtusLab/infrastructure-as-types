...
object EventsApi {
  ...
  def apply(baseUrl: String = "http://localhost")(implicit serializer: SttpSerializer) = new EventsApi(baseUrl)
}

class EventsApi(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue): ApiRequestT[APIGroup] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/apis/events.k8s.io/")
