...
import com.virtuslab.kubernetes.client.openapi.model.V1beta1Lease
import com.virtuslab.kubernetes.client.openapi.model.V1beta1LeaseList
...
object CoordinationV1beta1Api {
  ...
  def apply(baseUrl: String = "http://localhost") = new CoordinationV1beta1Api(baseUrl)
}

class CoordinationV1beta1Api(baseUrl: String) {
  
  /**
   * create a Lease
   * 
   * Expected answers:
   *   code 200 : V1beta1Lease (OK)
   *   code 201 : V1beta1Lease (Created)
   *   code 202 : V1beta1Lease (Accepted)
   ...
   * @param body 
   */
  def createNamespacedLease(namespace: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, body: V1beta1Lease)(implicit apiKey: ApiKeyValue
): ApiRequest[V1beta1Lease] =
    ApiRequest[V1beta1Lease](ApiMethods.POST, baseUrl, "/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases", "application/json")
      ...
      .withSuccessResponse[V1beta1Lease](200)
      .withErrorResponse[V1beta1Lease](201)
      .withErrorResponse[V1beta1Lease](202)
  ...
  def deleteCollectionNamespacedLease(namespace: String, pretty: Option[String] = None, allowWatchBookmarks: Option[Boolean] = None, continue: Option[String] = None, dryRun: Option[String] = None, fieldSelector: Option[String] = None, gracePeriodSeconds: Option[Int] = None, labelSelector: Option[String] = None, limit: Option[Int] = None, orphanDependents: Option[Boolean] = None, propagationPolicy: Option[String] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Int] = None, watch: Option[Boolean] = None, body: Option[V1DeleteOptions] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1Status](ApiMethods.DELETE, baseUrl, "/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
   ...
   * @param body 
   */
  def deleteNamespacedLease(name: String, namespace: String, pretty: Option[String] = None, dryRun: Option[String] = None, gracePeriodSeconds: Option[Int] = None, orphanDependents: Option[Boolean] = None, propagationPolicy: Option[String] = None, body: Option[V1DeleteOptions] = None)(implicit apiKey: ApiKeyValue
): ApiRequest[V1Status] =
    ApiRequest[V1Status](ApiMethods.DELETE, baseUrl, "/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
  ...
  def getAPIResources()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIResourceList](ApiMethods.GET, baseUrl, "/apis/coordination.k8s.io/v1beta1/", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
...
): ApiRequest[V1beta1LeaseList] =
    ApiRequest[V1beta1LeaseList](ApiMethods.GET, baseUrl, "/apis/coordination.k8s.io/v1beta1/leases", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("allowWatchBookmarks", allowWatchBookmarks)
      .withQueryParam("continue", continue)
      .withQueryParam("fieldSelector", fieldSelector)
      ...
      .withQueryParam("timeoutSeconds", timeoutSeconds)
      .withQueryParam("watch", watch)
      .withSuccessResponse[V1beta1LeaseList](200)
      .withErrorResponse[Unit](401)
  ...
  def listNamespacedLease(namespace: String, pretty: Option[String] = None, allowWatchBookmarks: Option[Boolean] = None, continue: Option[String] = None, fieldSelector: Option[String] = None, labelSelector: Option[String] = None, limit: Option[Int] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Int] = None, watch: Option[Boolean] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1beta1LeaseList](ApiMethods.GET, baseUrl, "/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("pretty", pretty)
      .withQueryParam("allowWatchBookmarks", allowWatchBookmarks)
      .withQueryParam("continue", continue)
   ...
   * @param body 
   */
  def patchNamespacedLease(name: String, namespace: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, force: Option[Boolean] = None, body: V1Patch)(implicit apiKey: ApiKeyValue
): ApiRequest[V1beta1Lease] =
    ApiRequest[V1beta1Lease](ApiMethods.PATCH, baseUrl, "/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}", "application/json-patch+json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
   ...
   */
  def readNamespacedLease(name: String, namespace: String, pretty: Option[String] = None, exact: Option[Boolean] = None, export: Option[Boolean] = None)(implicit apiKey: ApiKeyValue
): ApiRequest[V1beta1Lease] =
    ApiRequest[V1beta1Lease](ApiMethods.GET, baseUrl, "/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("pretty", pretty)
   ...
   * @param body 
   */
  def replaceNamespacedLease(name: String, namespace: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, body: V1beta1Lease)(implicit apiKey: ApiKeyValue
): ApiRequest[V1beta1Lease] =
    ApiRequest[V1beta1Lease](ApiMethods.PUT, baseUrl, "/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
