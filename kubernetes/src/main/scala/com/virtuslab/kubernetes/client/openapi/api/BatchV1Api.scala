...
class BatchV1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def deleteNamespacedJob(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/batch/v1/namespaces/${namespace}/jobs/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def listJobForAllNamespaces(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/batch/v1/jobs?allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&pretty=$pretty&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  def listNamespacedJob(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/batch/v1/namespaces/${namespace}/jobs?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .response(asJson[JobList])
  ...
  def patchNamespacedJobStatus(
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/batch/v1/namespaces/${namespace}/jobs/${name}/status?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
      .contentType("application/json-patch+json")
      .header("authorization", apiKey.value)
      .body(body)
