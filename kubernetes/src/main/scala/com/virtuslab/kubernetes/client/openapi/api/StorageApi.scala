...
object StorageApi {
  ...
  def apply(baseUrl: String = "http://localhost") = new StorageApi(baseUrl)
}

class StorageApi(baseUrl: String) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIGroup](ApiMethods.GET, baseUrl, "/apis/storage.k8s.io/", "application/json")
