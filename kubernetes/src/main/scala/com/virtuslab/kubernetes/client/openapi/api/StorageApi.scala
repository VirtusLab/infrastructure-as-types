...
object StorageApi {
  ...
  def apply(baseUrl: String = "http://localhost")(implicit serializer: SttpSerializer) = new StorageApi(baseUrl)
}

class StorageApi(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue): ApiRequestT[APIGroup] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/apis/storage.k8s.io/")
