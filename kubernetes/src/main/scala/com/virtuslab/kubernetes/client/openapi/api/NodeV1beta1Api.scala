...
class NodeV1beta1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def deleteRuntimeClass(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/node.k8s.io/v1beta1/runtimeclasses/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def listRuntimeClass(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/node.k8s.io/v1beta1/runtimeclasses?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
