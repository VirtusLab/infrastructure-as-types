...
class ApiregistrationV1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def deleteAPIService(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/apiregistration.k8s.io/v1/apiservices/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def listAPIService(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/apiregistration.k8s.io/v1/apiservices?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  def patchAPIServiceStatus(
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/apiregistration.k8s.io/v1/apiservices/${name}/status?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
      .contentType("application/json-patch+json")
      .header("authorization", apiKey.value)
      .body(body)
