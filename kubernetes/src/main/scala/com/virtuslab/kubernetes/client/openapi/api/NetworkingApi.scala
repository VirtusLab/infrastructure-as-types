...
object NetworkingApi {
  ...
  def apply(baseUrl: String = "http://localhost") = new NetworkingApi(baseUrl)
}

class NetworkingApi(baseUrl: String) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIGroup](ApiMethods.GET, baseUrl, "/apis/networking.k8s.io/", "application/json")
