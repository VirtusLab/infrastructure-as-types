...
object NetworkingApi {
  ...
  def apply(baseUrl: String = "http://localhost")(implicit serializer: SttpSerializer) = new NetworkingApi(baseUrl)
}

class NetworkingApi(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue): ApiRequestT[APIGroup] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/apis/networking.k8s.io/")
