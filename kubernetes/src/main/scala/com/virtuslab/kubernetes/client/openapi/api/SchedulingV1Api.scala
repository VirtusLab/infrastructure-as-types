...
class SchedulingV1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def deletePriorityClass(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/scheduling.k8s.io/v1/priorityclasses/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def listPriorityClass(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/scheduling.k8s.io/v1/priorityclasses?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  def patchPriorityClass(
    ...
    basicRequest
      .method(Method.PATCH,
              uri"$baseUrl/apis/scheduling.k8s.io/v1/priorityclasses/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force")
