...
class BatchV2alpha1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def deleteNamespacedCronJob(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/batch/v2alpha1/namespaces/${namespace}/cronjobs/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def listCronJobForAllNamespaces(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/batch/v2alpha1/cronjobs?allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&pretty=$pretty&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  def listNamespacedCronJob(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/batch/v2alpha1/namespaces/${namespace}/cronjobs?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .response(asJson[CronJobList])
  ...
  def patchNamespacedCronJob(
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/batch/v2alpha1/namespaces/${namespace}/cronjobs/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
  ...
  def patchNamespacedCronJobStatus(
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/batch/v2alpha1/namespaces/${namespace}/cronjobs/${name}/status?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
      .contentType("application/json-patch+json")
      .header("authorization", apiKey.value)
      .body(body)
