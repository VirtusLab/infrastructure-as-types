...
object AuthenticationApi {
  ...
  def apply(baseUrl: String = "http://localhost") = new AuthenticationApi(baseUrl)
}
...
class AuthenticationApi(baseUrl: String) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIGroup](ApiMethods.GET, baseUrl, "/apis/authentication.k8s.io/", "application/json")
