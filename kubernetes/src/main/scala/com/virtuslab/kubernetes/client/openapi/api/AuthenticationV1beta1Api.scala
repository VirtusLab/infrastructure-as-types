...
import com.virtuslab.kubernetes.client.openapi.model.TokenReview
...
object AuthenticationV1beta1Api {
  ...
  def apply(baseUrl: String = "http://localhost")(implicit serializer: SttpSerializer) = new AuthenticationV1beta1Api(baseUrl)
}

class AuthenticationV1beta1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def getAPIResources()(implicit apiKey: ApiKeyValue): ApiRequestT[APIResourceList] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/apis/authentication.k8s.io/v1beta1/")
      .contentType("application/json")
      .header("authorization", apiKey.value)
