...
object AppsApi {
  ...
  def apply(baseUrl: String = "http://localhost") = new AppsApi(baseUrl)
}

class AppsApi(baseUrl: String) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIGroup](ApiMethods.GET, baseUrl, "/apis/apps/", "application/json")
