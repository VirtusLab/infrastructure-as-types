...
object AppsApi {
  ...
  def apply(baseUrl: String = "http://localhost")(implicit serializer: SttpSerializer) = new AppsApi(baseUrl)
}

class AppsApi(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue): ApiRequestT[APIGroup] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/apis/apps/")
