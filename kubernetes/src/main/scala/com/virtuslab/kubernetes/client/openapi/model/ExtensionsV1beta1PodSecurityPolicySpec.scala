...
case class ExtensionsV1beta1PodSecurityPolicySpec (
  ...
  allowedCSIDrivers: Option[Seq[ExtensionsV1beta1AllowedCSIDriver]] = None,
  ...
  allowedFlexVolumes: Option[Seq[ExtensionsV1beta1AllowedFlexVolume]] = None,
  /* allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used. */
  allowedHostPaths: Option[Seq[ExtensionsV1beta1AllowedHostPath]] = None,
  ...
  hostPorts: Option[Seq[ExtensionsV1beta1HostPortRange]] = None,
  ...
  runAsGroup: Option[ExtensionsV1beta1RunAsGroupStrategyOptions] = None,
  runAsUser: ExtensionsV1beta1RunAsUserStrategyOptions,
  runtimeClass: Option[ExtensionsV1beta1RuntimeClassStrategyOptions] = None,
