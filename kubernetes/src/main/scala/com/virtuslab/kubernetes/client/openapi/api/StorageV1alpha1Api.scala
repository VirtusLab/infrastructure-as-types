...
class StorageV1alpha1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def deleteVolumeAttachment(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/storage.k8s.io/v1alpha1/volumeattachments/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def listVolumeAttachment(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/storage.k8s.io/v1alpha1/volumeattachments?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  def patchVolumeAttachment(
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/storage.k8s.io/v1alpha1/volumeattachments/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
