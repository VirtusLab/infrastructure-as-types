...
import com.virtuslab.kubernetes.client.openapi.model.V1alpha1VolumeAttachment
import com.virtuslab.kubernetes.client.openapi.model.V1alpha1VolumeAttachmentList
...
object StorageV1alpha1Api {
  ...
  def apply(baseUrl: String = "http://localhost") = new StorageV1alpha1Api(baseUrl)
}

class StorageV1alpha1Api(baseUrl: String) {
  
  /**
   * create a VolumeAttachment
   * 
   * Expected answers:
   *   code 200 : V1alpha1VolumeAttachment (OK)
   *   code 201 : V1alpha1VolumeAttachment (Created)
   *   code 202 : V1alpha1VolumeAttachment (Accepted)
   ...
   * @param body 
   */
  def createVolumeAttachment(pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, body: V1alpha1VolumeAttachment)(implicit apiKey: ApiKeyValue
): ApiRequest[V1alpha1VolumeAttachment] =
    ApiRequest[V1alpha1VolumeAttachment](ApiMethods.POST, baseUrl, "/apis/storage.k8s.io/v1alpha1/volumeattachments", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
      .withQueryParam("fieldManager", fieldManager)
      .withSuccessResponse[V1alpha1VolumeAttachment](200)
      .withErrorResponse[V1alpha1VolumeAttachment](201)
      .withErrorResponse[V1alpha1VolumeAttachment](202)
  ...
  def deleteCollectionVolumeAttachment(pretty: Option[String] = None, allowWatchBookmarks: Option[Boolean] = None, continue: Option[String] = None, dryRun: Option[String] = None, fieldSelector: Option[String] = None, gracePeriodSeconds: Option[Int] = None, labelSelector: Option[String] = None, limit: Option[Int] = None, orphanDependents: Option[Boolean] = None, propagationPolicy: Option[String] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Int] = None, watch: Option[Boolean] = None, body: Option[V1DeleteOptions] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1Status](ApiMethods.DELETE, baseUrl, "/apis/storage.k8s.io/v1alpha1/volumeattachments", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
  ...
  def deleteVolumeAttachment(name: String, pretty: Option[String] = None, dryRun: Option[String] = None, gracePeriodSeconds: Option[Int] = None, orphanDependents: Option[Boolean] = None, propagationPolicy: Option[String] = None, body: Option[V1DeleteOptions] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1Status](ApiMethods.DELETE, baseUrl, "/apis/storage.k8s.io/v1alpha1/volumeattachments/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
  ...
  def getAPIResources()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIResourceList](ApiMethods.GET, baseUrl, "/apis/storage.k8s.io/v1alpha1/", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
   ...
   * 
   * Expected answers:
   *   code 200 : V1alpha1VolumeAttachmentList (OK)
   *   code 401 :  (Unauthorized)
   * 
   * Available security schemes:
   *   BearerToken (apiKey)
...
): ApiRequest[V1alpha1VolumeAttachmentList] =
    ApiRequest[V1alpha1VolumeAttachmentList](ApiMethods.GET, baseUrl, "/apis/storage.k8s.io/v1alpha1/volumeattachments", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("pretty", pretty)
      .withQueryParam("allowWatchBookmarks", allowWatchBookmarks)
      .withQueryParam("continue", continue)
      ...
      .withQueryParam("timeoutSeconds", timeoutSeconds)
      .withQueryParam("watch", watch)
      .withSuccessResponse[V1alpha1VolumeAttachmentList](200)
      .withErrorResponse[Unit](401)
  ...
  def patchVolumeAttachment(name: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, force: Option[Boolean] = None, body: V1Patch)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1alpha1VolumeAttachment](ApiMethods.PATCH, baseUrl, "/apis/storage.k8s.io/v1alpha1/volumeattachments/{name}", "application/json-patch+json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
  ...
  def readVolumeAttachment(name: String, pretty: Option[String] = None, exact: Option[Boolean] = None, export: Option[Boolean] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1alpha1VolumeAttachment](ApiMethods.GET, baseUrl, "/apis/storage.k8s.io/v1alpha1/volumeattachments/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("pretty", pretty)
   ...
   * @param body 
   */
  def replaceVolumeAttachment(name: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, body: V1alpha1VolumeAttachment)(implicit apiKey: ApiKeyValue
): ApiRequest[V1alpha1VolumeAttachment] =
    ApiRequest[V1alpha1VolumeAttachment](ApiMethods.PUT, baseUrl, "/apis/storage.k8s.io/v1alpha1/volumeattachments/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
