...
class AuditregistrationV1alpha1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def deleteAuditSink(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/auditregistration.k8s.io/v1alpha1/auditsinks/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def listAuditSink(
      ...
      apiKey: ApiKeyValue
    ): ApiRequestT[AuditSinkList] =
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/auditregistration.k8s.io/v1alpha1/auditsinks?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  def patchAuditSink(
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/auditregistration.k8s.io/v1alpha1/auditsinks/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
