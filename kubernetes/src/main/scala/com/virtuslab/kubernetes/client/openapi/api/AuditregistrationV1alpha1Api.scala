...
import com.virtuslab.kubernetes.client.openapi.model.V1alpha1AuditSink
import com.virtuslab.kubernetes.client.openapi.model.V1alpha1AuditSinkList
...
object AuditregistrationV1alpha1Api {
  ...
  def apply(baseUrl: String = "http://localhost") = new AuditregistrationV1alpha1Api(baseUrl)
}

class AuditregistrationV1alpha1Api(baseUrl: String) {
  
  /**
   * create an AuditSink
   * 
   * Expected answers:
   *   code 200 : V1alpha1AuditSink (OK)
   *   code 201 : V1alpha1AuditSink (Created)
   *   code 202 : V1alpha1AuditSink (Accepted)
   ...
   * @param body 
   */
  def createAuditSink(pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, body: V1alpha1AuditSink)(implicit apiKey: ApiKeyValue
): ApiRequest[V1alpha1AuditSink] =
    ApiRequest[V1alpha1AuditSink](ApiMethods.POST, baseUrl, "/apis/auditregistration.k8s.io/v1alpha1/auditsinks", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
      .withQueryParam("fieldManager", fieldManager)
      .withSuccessResponse[V1alpha1AuditSink](200)
      .withErrorResponse[V1alpha1AuditSink](201)
      .withErrorResponse[V1alpha1AuditSink](202)
   ...
   * @param body 
   */
  def deleteAuditSink(name: String, pretty: Option[String] = None, dryRun: Option[String] = None, gracePeriodSeconds: Option[Int] = None, orphanDependents: Option[Boolean] = None, propagationPolicy: Option[String] = None, body: Option[V1DeleteOptions] = None)(implicit apiKey: ApiKeyValue
): ApiRequest[V1Status] =
    ApiRequest[V1Status](ApiMethods.DELETE, baseUrl, "/apis/auditregistration.k8s.io/v1alpha1/auditsinks/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
  ...
  def deleteCollectionAuditSink(pretty: Option[String] = None, allowWatchBookmarks: Option[Boolean] = None, continue: Option[String] = None, dryRun: Option[String] = None, fieldSelector: Option[String] = None, gracePeriodSeconds: Option[Int] = None, labelSelector: Option[String] = None, limit: Option[Int] = None, orphanDependents: Option[Boolean] = None, propagationPolicy: Option[String] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Int] = None, watch: Option[Boolean] = None, body: Option[V1DeleteOptions] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1Status](ApiMethods.DELETE, baseUrl, "/apis/auditregistration.k8s.io/v1alpha1/auditsinks", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
  ...
  def getAPIResources()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIResourceList](ApiMethods.GET, baseUrl, "/apis/auditregistration.k8s.io/v1alpha1/", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
   ...
   * 
   * Expected answers:
   *   code 200 : V1alpha1AuditSinkList (OK)
   *   code 401 :  (Unauthorized)
   * 
   * Available security schemes:
   *   BearerToken (apiKey)
...
): ApiRequest[V1alpha1AuditSinkList] =
    ApiRequest[V1alpha1AuditSinkList](ApiMethods.GET, baseUrl, "/apis/auditregistration.k8s.io/v1alpha1/auditsinks", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("pretty", pretty)
      .withQueryParam("allowWatchBookmarks", allowWatchBookmarks)
      .withQueryParam("continue", continue)
      ...
      .withQueryParam("timeoutSeconds", timeoutSeconds)
      .withQueryParam("watch", watch)
      .withSuccessResponse[V1alpha1AuditSinkList](200)
      .withErrorResponse[Unit](401)
   ...
   * @param body 
   */
  def patchAuditSink(name: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, force: Option[Boolean] = None, body: V1Patch)(implicit apiKey: ApiKeyValue
): ApiRequest[V1alpha1AuditSink] =
    ApiRequest[V1alpha1AuditSink](ApiMethods.PATCH, baseUrl, "/apis/auditregistration.k8s.io/v1alpha1/auditsinks/{name}", "application/json-patch+json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
   ...
   */
  def readAuditSink(name: String, pretty: Option[String] = None, exact: Option[Boolean] = None, export: Option[Boolean] = None)(implicit apiKey: ApiKeyValue
): ApiRequest[V1alpha1AuditSink] =
    ApiRequest[V1alpha1AuditSink](ApiMethods.GET, baseUrl, "/apis/auditregistration.k8s.io/v1alpha1/auditsinks/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("pretty", pretty)
   ...
   * @param body 
   */
  def replaceAuditSink(name: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, body: V1alpha1AuditSink)(implicit apiKey: ApiKeyValue
): ApiRequest[V1alpha1AuditSink] =
    ApiRequest[V1alpha1AuditSink](ApiMethods.PUT, baseUrl, "/apis/auditregistration.k8s.io/v1alpha1/auditsinks/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
