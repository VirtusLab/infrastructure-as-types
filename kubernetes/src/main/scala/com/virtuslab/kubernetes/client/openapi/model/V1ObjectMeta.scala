...
case class V1ObjectMeta (
  ...
  deletionTimestamp: Option[DateTime] = None,
  ...
  initializers: Option[V1Initializers] = None,
  ...
  managedFields: Option[Seq[V1ManagedFieldsEntry]] = None,
  ...
  ownerReferences: Option[Seq[V1OwnerReference]] = None,
