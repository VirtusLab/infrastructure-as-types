...
class StorageV1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def deleteCollectionVolumeAttachment(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/storage.k8s.io/v1/volumeattachments?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&dryRun=$dryRun&fieldSelector=$fieldSelector&gracePeriodSeconds=$gracePeriodSeconds&labelSelector=$labelSelector&limit=$limit&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def deleteStorageClass(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/storage.k8s.io/v1/storageclasses/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def deleteVolumeAttachment(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/storage.k8s.io/v1/volumeattachments/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def listStorageClass(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/storage.k8s.io/v1/storageclasses?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  def listVolumeAttachment(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/storage.k8s.io/v1/volumeattachments?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  /**
    ...
    * @param body
    */
  def patchVolumeAttachmentStatus(
      name: String,
      pretty: Option[String] = None,
      dryRun: Option[String] = None,
      fieldManager: Option[String] = None,
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/storage.k8s.io/v1/volumeattachments/${name}/status?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
      .contentType("application/json-patch+json")
      .header("authorization", apiKey.value)
      .body(body)
