...
object RbacAuthorizationApi {
  ...
  def apply(baseUrl: String = "http://localhost") = new RbacAuthorizationApi(baseUrl)
}

class RbacAuthorizationApi(baseUrl: String) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIGroup](ApiMethods.GET, baseUrl, "/apis/rbac.authorization.k8s.io/", "application/json")
