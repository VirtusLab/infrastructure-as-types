...
object AuthorizationApi {
  ...
  def apply(baseUrl: String = "http://localhost") = new AuthorizationApi(baseUrl)
}
...
class AuthorizationApi(baseUrl: String) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIGroup](ApiMethods.GET, baseUrl, "/apis/authorization.k8s.io/", "application/json")
