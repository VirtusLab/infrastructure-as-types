...
object CoordinationApi {
  ...
  def apply(baseUrl: String = "http://localhost") = new CoordinationApi(baseUrl)
}

class CoordinationApi(baseUrl: String) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIGroup](ApiMethods.GET, baseUrl, "/apis/coordination.k8s.io/", "application/json")
