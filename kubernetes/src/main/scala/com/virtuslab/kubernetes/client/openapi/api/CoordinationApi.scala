...
object CoordinationApi {
  ...
  def apply(baseUrl: String = "http://localhost")(implicit serializer: SttpSerializer) = new CoordinationApi(baseUrl)
}

class CoordinationApi(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue): ApiRequestT[APIGroup] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/apis/coordination.k8s.io/")
