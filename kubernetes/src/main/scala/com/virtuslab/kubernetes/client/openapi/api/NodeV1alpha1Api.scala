...
import com.virtuslab.kubernetes.client.openapi.model.V1alpha1RuntimeClass
import com.virtuslab.kubernetes.client.openapi.model.V1alpha1RuntimeClassList
...
object NodeV1alpha1Api {
  ...
  def apply(baseUrl: String = "http://localhost") = new NodeV1alpha1Api(baseUrl)
}

class NodeV1alpha1Api(baseUrl: String) {
  
  /**
   * create a RuntimeClass
   * 
   * Expected answers:
   *   code 200 : V1alpha1RuntimeClass (OK)
   *   code 201 : V1alpha1RuntimeClass (Created)
   *   code 202 : V1alpha1RuntimeClass (Accepted)
   ...
   * @param body 
   */
  def createRuntimeClass(pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, body: V1alpha1RuntimeClass)(implicit apiKey: ApiKeyValue
): ApiRequest[V1alpha1RuntimeClass] =
    ApiRequest[V1alpha1RuntimeClass](ApiMethods.POST, baseUrl, "/apis/node.k8s.io/v1alpha1/runtimeclasses", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
      .withQueryParam("fieldManager", fieldManager)
      .withSuccessResponse[V1alpha1RuntimeClass](200)
      .withErrorResponse[V1alpha1RuntimeClass](201)
      .withErrorResponse[V1alpha1RuntimeClass](202)
  ...
  def deleteCollectionRuntimeClass(pretty: Option[String] = None, allowWatchBookmarks: Option[Boolean] = None, continue: Option[String] = None, dryRun: Option[String] = None, fieldSelector: Option[String] = None, gracePeriodSeconds: Option[Int] = None, labelSelector: Option[String] = None, limit: Option[Int] = None, orphanDependents: Option[Boolean] = None, propagationPolicy: Option[String] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Int] = None, watch: Option[Boolean] = None, body: Option[V1DeleteOptions] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1Status](ApiMethods.DELETE, baseUrl, "/apis/node.k8s.io/v1alpha1/runtimeclasses", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
   ...
   * @param body 
   */
  def deleteRuntimeClass(name: String, pretty: Option[String] = None, dryRun: Option[String] = None, gracePeriodSeconds: Option[Int] = None, orphanDependents: Option[Boolean] = None, propagationPolicy: Option[String] = None, body: Option[V1DeleteOptions] = None)(implicit apiKey: ApiKeyValue
): ApiRequest[V1Status] =
    ApiRequest[V1Status](ApiMethods.DELETE, baseUrl, "/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
  ...
  def getAPIResources()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIResourceList](ApiMethods.GET, baseUrl, "/apis/node.k8s.io/v1alpha1/", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
   ...
   * 
   * Expected answers:
   *   code 200 : V1alpha1RuntimeClassList (OK)
   *   code 401 :  (Unauthorized)
   * 
   * Available security schemes:
   *   BearerToken (apiKey)
...
): ApiRequest[V1alpha1RuntimeClassList] =
    ApiRequest[V1alpha1RuntimeClassList](ApiMethods.GET, baseUrl, "/apis/node.k8s.io/v1alpha1/runtimeclasses", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("pretty", pretty)
      .withQueryParam("allowWatchBookmarks", allowWatchBookmarks)
      .withQueryParam("continue", continue)
      ...
      .withQueryParam("timeoutSeconds", timeoutSeconds)
      .withQueryParam("watch", watch)
      .withSuccessResponse[V1alpha1RuntimeClassList](200)
      .withErrorResponse[Unit](401)
   ...
   * @param body 
   */
  def patchRuntimeClass(name: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, force: Option[Boolean] = None, body: V1Patch)(implicit apiKey: ApiKeyValue
): ApiRequest[V1alpha1RuntimeClass] =
    ApiRequest[V1alpha1RuntimeClass](ApiMethods.PATCH, baseUrl, "/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}", "application/json-patch+json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
   ...
   */
  def readRuntimeClass(name: String, pretty: Option[String] = None, exact: Option[Boolean] = None, export: Option[Boolean] = None)(implicit apiKey: ApiKeyValue
): ApiRequest[V1alpha1RuntimeClass] =
    ApiRequest[V1alpha1RuntimeClass](ApiMethods.GET, baseUrl, "/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("pretty", pretty)
   ...
   * @param body 
   */
  def replaceRuntimeClass(name: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, body: V1alpha1RuntimeClass)(implicit apiKey: ApiKeyValue
): ApiRequest[V1alpha1RuntimeClass] =
    ApiRequest[V1alpha1RuntimeClass](ApiMethods.PUT, baseUrl, "/apis/node.k8s.io/v1alpha1/runtimeclasses/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
