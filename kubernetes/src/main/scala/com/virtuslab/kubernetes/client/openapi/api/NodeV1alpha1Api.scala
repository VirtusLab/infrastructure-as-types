...
class NodeV1alpha1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def createRuntimeClass(
    ...
    basicRequest
      .method(Method.POST,
              uri"$baseUrl/apis/node.k8s.io/v1alpha1/runtimeclasses?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager")
  ...
  def readRuntimeClass(
    ...
    basicRequest
      .method(Method.GET,
              uri"$baseUrl/apis/node.k8s.io/v1alpha1/runtimeclasses/${name}?pretty=$pretty&exact=$exact&export=$export")
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .response(asJson[RuntimeClass])
  ...
  def replaceRuntimeClass(
    ...
    basicRequest
      .method(
        Method.PUT,
        uri"$baseUrl/apis/node.k8s.io/v1alpha1/runtimeclasses/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
