...
import com.virtuslab.kubernetes.client.openapi.model.V1beta1PriorityClass
import com.virtuslab.kubernetes.client.openapi.model.V1beta1PriorityClassList
...
object SchedulingV1beta1Api {
  ...
  def apply(baseUrl: String = "http://localhost") = new SchedulingV1beta1Api(baseUrl)
}

class SchedulingV1beta1Api(baseUrl: String) {
  
  /**
   * create a PriorityClass
   * 
   * Expected answers:
   *   code 200 : V1beta1PriorityClass (OK)
   *   code 201 : V1beta1PriorityClass (Created)
   *   code 202 : V1beta1PriorityClass (Accepted)
   ...
   * @param body 
   */
  def createPriorityClass(pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, body: V1beta1PriorityClass)(implicit apiKey: ApiKeyValue
): ApiRequest[V1beta1PriorityClass] =
    ApiRequest[V1beta1PriorityClass](ApiMethods.POST, baseUrl, "/apis/scheduling.k8s.io/v1beta1/priorityclasses", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
      .withQueryParam("fieldManager", fieldManager)
      .withSuccessResponse[V1beta1PriorityClass](200)
      .withErrorResponse[V1beta1PriorityClass](201)
      .withErrorResponse[V1beta1PriorityClass](202)
  ...
  def deleteCollectionPriorityClass(pretty: Option[String] = None, allowWatchBookmarks: Option[Boolean] = None, continue: Option[String] = None, dryRun: Option[String] = None, fieldSelector: Option[String] = None, gracePeriodSeconds: Option[Int] = None, labelSelector: Option[String] = None, limit: Option[Int] = None, orphanDependents: Option[Boolean] = None, propagationPolicy: Option[String] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Int] = None, watch: Option[Boolean] = None, body: Option[V1DeleteOptions] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1Status](ApiMethods.DELETE, baseUrl, "/apis/scheduling.k8s.io/v1beta1/priorityclasses", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
  ...
  def deletePriorityClass(name: String, pretty: Option[String] = None, dryRun: Option[String] = None, gracePeriodSeconds: Option[Int] = None, orphanDependents: Option[Boolean] = None, propagationPolicy: Option[String] = None, body: Option[V1DeleteOptions] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1Status](ApiMethods.DELETE, baseUrl, "/apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
  ...
  def getAPIResources()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIResourceList](ApiMethods.GET, baseUrl, "/apis/scheduling.k8s.io/v1beta1/", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
   ...
   * 
   * Expected answers:
   *   code 200 : V1beta1PriorityClassList (OK)
   *   code 401 :  (Unauthorized)
   * 
   * Available security schemes:
   *   BearerToken (apiKey)
...
): ApiRequest[V1beta1PriorityClassList] =
    ApiRequest[V1beta1PriorityClassList](ApiMethods.GET, baseUrl, "/apis/scheduling.k8s.io/v1beta1/priorityclasses", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("pretty", pretty)
      .withQueryParam("allowWatchBookmarks", allowWatchBookmarks)
      .withQueryParam("continue", continue)
      ...
      .withQueryParam("timeoutSeconds", timeoutSeconds)
      .withQueryParam("watch", watch)
      .withSuccessResponse[V1beta1PriorityClassList](200)
      .withErrorResponse[Unit](401)
  ...
  def patchPriorityClass(name: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, force: Option[Boolean] = None, body: V1Patch)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1beta1PriorityClass](ApiMethods.PATCH, baseUrl, "/apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}", "application/json-patch+json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
  ...
  def readPriorityClass(name: String, pretty: Option[String] = None, exact: Option[Boolean] = None, export: Option[Boolean] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1beta1PriorityClass](ApiMethods.GET, baseUrl, "/apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("pretty", pretty)
   ...
   * @param body 
   */
  def replacePriorityClass(name: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, body: V1beta1PriorityClass)(implicit apiKey: ApiKeyValue
): ApiRequest[V1beta1PriorityClass] =
    ApiRequest[V1beta1PriorityClass](ApiMethods.PUT, baseUrl, "/apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
