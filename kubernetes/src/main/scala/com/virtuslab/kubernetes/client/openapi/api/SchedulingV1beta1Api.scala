...
class SchedulingV1beta1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def createPriorityClass(
    ...
    basicRequest
      .method(
        Method.POST,
        uri"$baseUrl/apis/scheduling.k8s.io/v1beta1/priorityclasses?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager"
      )
  ...
  def readPriorityClass(
    ...
    basicRequest
      .method(Method.GET,
              uri"$baseUrl/apis/scheduling.k8s.io/v1beta1/priorityclasses/${name}?pretty=$pretty&exact=$exact&export=$export")
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .response(asJson[PriorityClass])
  ...
  def replacePriorityClass(
    ...
    basicRequest
      .method(
        Method.PUT,
        uri"$baseUrl/apis/scheduling.k8s.io/v1beta1/priorityclasses/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
