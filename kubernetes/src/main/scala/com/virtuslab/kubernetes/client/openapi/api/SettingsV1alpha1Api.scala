...
import com.virtuslab.kubernetes.client.openapi.model.V1alpha1PodPreset
import com.virtuslab.kubernetes.client.openapi.model.V1alpha1PodPresetList
...
object SettingsV1alpha1Api {
  ...
  def apply(baseUrl: String = "http://localhost") = new SettingsV1alpha1Api(baseUrl)
}

class SettingsV1alpha1Api(baseUrl: String) {
  
  /**
   * create a PodPreset
   * 
   * Expected answers:
   *   code 200 : V1alpha1PodPreset (OK)
   *   code 201 : V1alpha1PodPreset (Created)
   *   code 202 : V1alpha1PodPreset (Accepted)
   ...
   * @param body 
   */
  def createNamespacedPodPreset(namespace: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, body: V1alpha1PodPreset)(implicit apiKey: ApiKeyValue
): ApiRequest[V1alpha1PodPreset] =
    ApiRequest[V1alpha1PodPreset](ApiMethods.POST, baseUrl, "/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets", "application/json")
      ...
      .withSuccessResponse[V1alpha1PodPreset](200)
      .withErrorResponse[V1alpha1PodPreset](201)
      .withErrorResponse[V1alpha1PodPreset](202)
  ...
  def deleteCollectionNamespacedPodPreset(namespace: String, pretty: Option[String] = None, allowWatchBookmarks: Option[Boolean] = None, continue: Option[String] = None, dryRun: Option[String] = None, fieldSelector: Option[String] = None, gracePeriodSeconds: Option[Int] = None, labelSelector: Option[String] = None, limit: Option[Int] = None, orphanDependents: Option[Boolean] = None, propagationPolicy: Option[String] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Int] = None, watch: Option[Boolean] = None, body: Option[V1DeleteOptions] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1Status](ApiMethods.DELETE, baseUrl, "/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
   ...
   * @param body 
   */
  def deleteNamespacedPodPreset(name: String, namespace: String, pretty: Option[String] = None, dryRun: Option[String] = None, gracePeriodSeconds: Option[Int] = None, orphanDependents: Option[Boolean] = None, propagationPolicy: Option[String] = None, body: Option[V1DeleteOptions] = None)(implicit apiKey: ApiKeyValue
): ApiRequest[V1Status] =
    ApiRequest[V1Status](ApiMethods.DELETE, baseUrl, "/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
  ...
  def getAPIResources()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIResourceList](ApiMethods.GET, baseUrl, "/apis/settings.k8s.io/v1alpha1/", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
   ...
   * 
   * Expected answers:
   *   code 200 : V1alpha1PodPresetList (OK)
   *   code 401 :  (Unauthorized)
   * 
   * Available security schemes:
   *   BearerToken (apiKey)
...
): ApiRequest[V1alpha1PodPresetList] =
    ApiRequest[V1alpha1PodPresetList](ApiMethods.GET, baseUrl, "/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("pretty", pretty)
      .withQueryParam("allowWatchBookmarks", allowWatchBookmarks)
      .withQueryParam("continue", continue)
      ...
      .withQueryParam("watch", watch)
      .withPathParam("namespace", namespace)
      .withSuccessResponse[V1alpha1PodPresetList](200)
      .withErrorResponse[Unit](401)
  ...
  def listPodPresetForAllNamespaces(allowWatchBookmarks: Option[Boolean] = None, continue: Option[String] = None, fieldSelector: Option[String] = None, labelSelector: Option[String] = None, limit: Option[Int] = None, pretty: Option[String] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Int] = None, watch: Option[Boolean] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1alpha1PodPresetList](ApiMethods.GET, baseUrl, "/apis/settings.k8s.io/v1alpha1/podpresets", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("allowWatchBookmarks", allowWatchBookmarks)
      .withQueryParam("continue", continue)
      .withQueryParam("fieldSelector", fieldSelector)
   ...
   * @param body 
   */
  def patchNamespacedPodPreset(name: String, namespace: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, force: Option[Boolean] = None, body: V1Patch)(implicit apiKey: ApiKeyValue
): ApiRequest[V1alpha1PodPreset] =
    ApiRequest[V1alpha1PodPreset](ApiMethods.PATCH, baseUrl, "/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}", "application/json-patch+json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
   ...
   */
  def readNamespacedPodPreset(name: String, namespace: String, pretty: Option[String] = None, exact: Option[Boolean] = None, export: Option[Boolean] = None)(implicit apiKey: ApiKeyValue
): ApiRequest[V1alpha1PodPreset] =
    ApiRequest[V1alpha1PodPreset](ApiMethods.GET, baseUrl, "/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("pretty", pretty)
   ...
   * @param body 
   */
  def replaceNamespacedPodPreset(name: String, namespace: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, body: V1alpha1PodPreset)(implicit apiKey: ApiKeyValue
): ApiRequest[V1alpha1PodPreset] =
    ApiRequest[V1alpha1PodPreset](ApiMethods.PUT, baseUrl, "/apis/settings.k8s.io/v1alpha1/namespaces/{namespace}/podpresets/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
