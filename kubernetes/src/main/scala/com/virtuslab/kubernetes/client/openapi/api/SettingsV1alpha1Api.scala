...
class SettingsV1alpha1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def deleteNamespacedPodPreset(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/settings.k8s.io/v1alpha1/namespaces/${namespace}/podpresets/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def listNamespacedPodPreset(
      ...
      apiKey: ApiKeyValue
    ): ApiRequestT[PodPresetList] =
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/settings.k8s.io/v1alpha1/namespaces/${namespace}/podpresets?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  def listPodPresetForAllNamespaces(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/settings.k8s.io/v1alpha1/podpresets?allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&pretty=$pretty&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .response(asJson[PodPresetList])
  ...
  def patchNamespacedPodPreset(
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/settings.k8s.io/v1alpha1/namespaces/${namespace}/podpresets/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
  ...
  def replaceNamespacedPodPreset(
    ...
    basicRequest
      .method(
        Method.PUT,
        uri"$baseUrl/apis/settings.k8s.io/v1alpha1/namespaces/${namespace}/podpresets/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
