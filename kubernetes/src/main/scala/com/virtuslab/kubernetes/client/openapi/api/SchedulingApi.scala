...
object SchedulingApi {
  ...
  def apply(baseUrl: String = "http://localhost") = new SchedulingApi(baseUrl)
}

class SchedulingApi(baseUrl: String) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIGroup](ApiMethods.GET, baseUrl, "/apis/scheduling.k8s.io/", "application/json")
