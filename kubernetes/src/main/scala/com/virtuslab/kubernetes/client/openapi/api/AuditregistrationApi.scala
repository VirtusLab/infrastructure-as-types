...
object AuditregistrationApi {
  ...
  def apply(baseUrl: String = "http://localhost") = new AuditregistrationApi(baseUrl)
}

class AuditregistrationApi(baseUrl: String) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIGroup](ApiMethods.GET, baseUrl, "/apis/auditregistration.k8s.io/", "application/json")
