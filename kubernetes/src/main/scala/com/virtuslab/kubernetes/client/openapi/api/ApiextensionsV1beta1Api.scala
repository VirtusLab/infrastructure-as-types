...
class ApiextensionsV1beta1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def deleteCustomResourceDefinition(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def listCustomResourceDefinition(
      ...
      apiKey: ApiKeyValue
    ): ApiRequestT[CustomResourceDefinitionList] =
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  def patchCustomResourceDefinition(
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
  ...
  /**
    ...
    * @param body
    */
  def patchCustomResourceDefinitionStatus(
      name: String,
      pretty: Option[String] = None,
      dryRun: Option[String] = None,
      fieldManager: Option[String] = None,
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/${name}/status?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
      .contentType("application/json-patch+json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def replaceCustomResourceDefinitionStatus(
    ...
    basicRequest
      .method(
        Method.PUT,
        uri"$baseUrl/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/${name}/status?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
