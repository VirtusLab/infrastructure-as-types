...
class PolicyV1beta1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def deleteCollectionPodSecurityPolicy(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/policy/v1beta1/podsecuritypolicies?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&dryRun=$dryRun&fieldSelector=$fieldSelector&gracePeriodSeconds=$gracePeriodSeconds&labelSelector=$labelSelector&limit=$limit&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def deleteNamespacedPodDisruptionBudget(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/policy/v1beta1/namespaces/${namespace}/poddisruptionbudgets/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def deletePodSecurityPolicy(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/policy/v1beta1/podsecuritypolicies/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def listNamespacedPodDisruptionBudget(
      ...
      apiKey: ApiKeyValue
    ): ApiRequestT[PodDisruptionBudgetList] =
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/policy/v1beta1/namespaces/${namespace}/poddisruptionbudgets?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  def listPodDisruptionBudgetForAllNamespaces(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/policy/v1beta1/poddisruptionbudgets?allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&pretty=$pretty&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .response(asJson[PodDisruptionBudgetList])
  ...
  def listPodSecurityPolicy(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/policy/v1beta1/podsecuritypolicies?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  def patchNamespacedPodDisruptionBudget(
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/policy/v1beta1/namespaces/${namespace}/poddisruptionbudgets/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
  ...
  /**
    ...
    * @param body
    */
  def patchNamespacedPodDisruptionBudgetStatus(
      name: String,
      namespace: String,
      pretty: Option[String] = None,
      dryRun: Option[String] = None,
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/policy/v1beta1/namespaces/${namespace}/poddisruptionbudgets/${name}/status?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
      .contentType("application/json-patch+json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  /**
    ...
    * @param pretty If 'true', then the output is pretty printed.
    */
  def readNamespacedPodDisruptionBudgetStatus(
      name: String,
      namespace: String,
      pretty: Option[String] = None
    )(implicit
  ...
  def replaceNamespacedPodDisruptionBudget(
    ...
    basicRequest
      .method(
        Method.PUT,
        uri"$baseUrl/apis/policy/v1beta1/namespaces/${namespace}/poddisruptionbudgets/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def replaceNamespacedPodDisruptionBudgetStatus(
    ...
    basicRequest
      .method(
        Method.PUT,
        uri"$baseUrl/apis/policy/v1beta1/namespaces/${namespace}/poddisruptionbudgets/${name}/status?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
