...
object ApiextensionsApi {
  ...
  def apply(baseUrl: String = "http://localhost") = new ApiextensionsApi(baseUrl)
}

class ApiextensionsApi(baseUrl: String) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIGroup](ApiMethods.GET, baseUrl, "/apis/apiextensions.k8s.io/", "application/json")
