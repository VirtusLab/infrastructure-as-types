...
object AutoscalingApi {
  ...
  def apply(baseUrl: String = "http://localhost") = new AutoscalingApi(baseUrl)
}

class AutoscalingApi(baseUrl: String) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIGroup](ApiMethods.GET, baseUrl, "/apis/autoscaling/", "application/json")
