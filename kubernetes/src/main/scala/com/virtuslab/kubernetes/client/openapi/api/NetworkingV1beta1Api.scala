...
class NetworkingV1beta1Api(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  def deleteNamespacedIngress(
    ...
    basicRequest
      .method(
        Method.DELETE,
        uri"$baseUrl/apis/networking.k8s.io/v1beta1/namespaces/${namespace}/ingresses/${name}?pretty=$pretty&dryRun=$dryRun&gracePeriodSeconds=$gracePeriodSeconds&orphanDependents=$orphanDependents&propagationPolicy=$propagationPolicy"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def listIngressForAllNamespaces(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/networking.k8s.io/v1beta1/ingresses?allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&pretty=$pretty&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
  ...
  def listNamespacedIngress(
    ...
    basicRequest
      .method(
        Method.GET,
        uri"$baseUrl/apis/networking.k8s.io/v1beta1/namespaces/${namespace}/ingresses?pretty=$pretty&allowWatchBookmarks=$allowWatchBookmarks&continue=$continue&fieldSelector=$fieldSelector&labelSelector=$labelSelector&limit=$limit&resourceVersion=$resourceVersion&timeoutSeconds=$timeoutSeconds&watch=$watch"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .response(asJson[IngressList])
  ...
  def patchNamespacedIngress(
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/networking.k8s.io/v1beta1/namespaces/${namespace}/ingresses/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
  ...
  def patchNamespacedIngressStatus(
    ...
    basicRequest
      .method(
        Method.PATCH,
        uri"$baseUrl/apis/networking.k8s.io/v1beta1/namespaces/${namespace}/ingresses/${name}/status?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager&force=$force"
      )
      .contentType("application/json-patch+json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def replaceNamespacedIngress(
    ...
    basicRequest
      .method(
        Method.PUT,
        uri"$baseUrl/apis/networking.k8s.io/v1beta1/namespaces/${namespace}/ingresses/${name}?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
  ...
  def replaceNamespacedIngressStatus(
    ...
    basicRequest
      .method(
        Method.PUT,
        uri"$baseUrl/apis/networking.k8s.io/v1beta1/namespaces/${namespace}/ingresses/${name}/status?pretty=$pretty&dryRun=$dryRun&fieldManager=$fieldManager"
      )
      .contentType("application/json")
      .header("authorization", apiKey.value)
      .body(body)
