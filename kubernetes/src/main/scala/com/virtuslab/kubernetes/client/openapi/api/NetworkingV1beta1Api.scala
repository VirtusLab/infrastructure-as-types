...
import com.virtuslab.kubernetes.client.openapi.model.NetworkingV1beta1Ingress
import com.virtuslab.kubernetes.client.openapi.model.NetworkingV1beta1IngressList
...
object NetworkingV1beta1Api {
  ...
  def apply(baseUrl: String = "http://localhost") = new NetworkingV1beta1Api(baseUrl)
}

class NetworkingV1beta1Api(baseUrl: String) {
  
  /**
   * create an Ingress
   * 
   * Expected answers:
   *   code 200 : NetworkingV1beta1Ingress (OK)
   *   code 201 : NetworkingV1beta1Ingress (Created)
   *   code 202 : NetworkingV1beta1Ingress (Accepted)
   ...
   * @param body 
   */
  def createNamespacedIngress(namespace: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, body: NetworkingV1beta1Ingress)(implicit apiKey: ApiKeyValue
): ApiRequest[NetworkingV1beta1Ingress] =
    ApiRequest[NetworkingV1beta1Ingress](ApiMethods.POST, baseUrl, "/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses", "application/json")
      ...
      .withSuccessResponse[NetworkingV1beta1Ingress](200)
      .withErrorResponse[NetworkingV1beta1Ingress](201)
      .withErrorResponse[NetworkingV1beta1Ingress](202)
  ...
  def deleteCollectionNamespacedIngress(namespace: String, pretty: Option[String] = None, allowWatchBookmarks: Option[Boolean] = None, continue: Option[String] = None, dryRun: Option[String] = None, fieldSelector: Option[String] = None, gracePeriodSeconds: Option[Int] = None, labelSelector: Option[String] = None, limit: Option[Int] = None, orphanDependents: Option[Boolean] = None, propagationPolicy: Option[String] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Int] = None, watch: Option[Boolean] = None, body: Option[V1DeleteOptions] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1Status](ApiMethods.DELETE, baseUrl, "/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
  ...
  def deleteNamespacedIngress(name: String, namespace: String, pretty: Option[String] = None, dryRun: Option[String] = None, gracePeriodSeconds: Option[Int] = None, orphanDependents: Option[Boolean] = None, propagationPolicy: Option[String] = None, body: Option[V1DeleteOptions] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1Status](ApiMethods.DELETE, baseUrl, "/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
  ...
  def getAPIResources()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIResourceList](ApiMethods.GET, baseUrl, "/apis/networking.k8s.io/v1beta1/", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
   ...
   * 
   * Expected answers:
   *   code 200 : NetworkingV1beta1IngressList (OK)
   *   code 401 :  (Unauthorized)
   * 
   * Available security schemes:
   *   BearerToken (apiKey)
...
): ApiRequest[NetworkingV1beta1IngressList] =
    ApiRequest[NetworkingV1beta1IngressList](ApiMethods.GET, baseUrl, "/apis/networking.k8s.io/v1beta1/ingresses", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("allowWatchBookmarks", allowWatchBookmarks)
      .withQueryParam("continue", continue)
      .withQueryParam("fieldSelector", fieldSelector)
      ...
      .withQueryParam("timeoutSeconds", timeoutSeconds)
      .withQueryParam("watch", watch)
      .withSuccessResponse[NetworkingV1beta1IngressList](200)
      .withErrorResponse[Unit](401)
  ...
  def listNamespacedIngress(namespace: String, pretty: Option[String] = None, allowWatchBookmarks: Option[Boolean] = None, continue: Option[String] = None, fieldSelector: Option[String] = None, labelSelector: Option[String] = None, limit: Option[Int] = None, resourceVersion: Option[String] = None, timeoutSeconds: Option[Int] = None, watch: Option[Boolean] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[NetworkingV1beta1IngressList](ApiMethods.GET, baseUrl, "/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("pretty", pretty)
      .withQueryParam("allowWatchBookmarks", allowWatchBookmarks)
      .withQueryParam("continue", continue)
  ...
  def patchNamespacedIngress(name: String, namespace: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, force: Option[Boolean] = None, body: V1Patch)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[NetworkingV1beta1Ingress](ApiMethods.PATCH, baseUrl, "/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}", "application/json-patch+json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
  ...
  def patchNamespacedIngressStatus(name: String, namespace: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, force: Option[Boolean] = None, body: V1Patch)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[NetworkingV1beta1Ingress](ApiMethods.PATCH, baseUrl, "/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}/status", "application/json-patch+json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
  ...
  def readNamespacedIngress(name: String, namespace: String, pretty: Option[String] = None, exact: Option[Boolean] = None, export: Option[Boolean] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[NetworkingV1beta1Ingress](ApiMethods.GET, baseUrl, "/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("pretty", pretty)
  ...
  def readNamespacedIngressStatus(name: String, namespace: String, pretty: Option[String] = None)(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[NetworkingV1beta1Ingress](ApiMethods.GET, baseUrl, "/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}/status", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withQueryParam("pretty", pretty)
      .withPathParam("name", name)
      .withPathParam("namespace", namespace)
   ...
   * @param body 
   */
  def replaceNamespacedIngress(name: String, namespace: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, body: NetworkingV1beta1Ingress)(implicit apiKey: ApiKeyValue
): ApiRequest[NetworkingV1beta1Ingress] =
    ApiRequest[NetworkingV1beta1Ingress](ApiMethods.PUT, baseUrl, "/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
   ...
   * @param body 
   */
  def replaceNamespacedIngressStatus(name: String, namespace: String, pretty: Option[String] = None, dryRun: Option[String] = None, fieldManager: Option[String] = None, body: NetworkingV1beta1Ingress)(implicit apiKey: ApiKeyValue
): ApiRequest[NetworkingV1beta1Ingress] =
    ApiRequest[NetworkingV1beta1Ingress](ApiMethods.PUT, baseUrl, "/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}/status", "application/json")
      .withApiKey(apiKey, "authorization", HEADER)
      .withBody(body)
      .withQueryParam("pretty", pretty)
      .withQueryParam("dryRun", dryRun)
