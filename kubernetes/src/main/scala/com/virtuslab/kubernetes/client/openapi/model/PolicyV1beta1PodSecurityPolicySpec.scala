...
case class PolicyV1beta1PodSecurityPolicySpec (
  ...
  allowedCSIDrivers: Option[Seq[PolicyV1beta1AllowedCSIDriver]] = None,
  ...
  allowedFlexVolumes: Option[Seq[PolicyV1beta1AllowedFlexVolume]] = None,
  /* allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used. */
  allowedHostPaths: Option[Seq[PolicyV1beta1AllowedHostPath]] = None,
  ...
  hostPorts: Option[Seq[PolicyV1beta1HostPortRange]] = None,
  ...
  runAsGroup: Option[PolicyV1beta1RunAsGroupStrategyOptions] = None,
  runAsUser: PolicyV1beta1RunAsUserStrategyOptions,
  runtimeClass: Option[PolicyV1beta1RuntimeClassStrategyOptions] = None,
