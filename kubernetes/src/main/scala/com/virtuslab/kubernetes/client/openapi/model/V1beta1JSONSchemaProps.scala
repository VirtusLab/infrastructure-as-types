...
case class V1beta1JSONSchemaProps (
  ...
  allOf: Option[Seq[V1beta1JSONSchemaProps]] = None,
  anyOf: Option[Seq[V1beta1JSONSchemaProps]] = None,
  ...
  definitions: Option[Map[String, V1beta1JSONSchemaProps]] = None,
  ...
  externalDocs: Option[V1beta1ExternalDocumentation] = None,
  ...
  not: Option[V1beta1JSONSchemaProps] = None,
  nullable: Option[Boolean] = None,
  oneOf: Option[Seq[V1beta1JSONSchemaProps]] = None,
  pattern: Option[String] = None,
  patternProperties: Option[Map[String, V1beta1JSONSchemaProps]] = None,
  properties: Option[Map[String, V1beta1JSONSchemaProps]] = None,
