...
object CertificatesApi {
  ...
  def apply(baseUrl: String = "http://localhost") = new CertificatesApi(baseUrl)
}

class CertificatesApi(baseUrl: String) {
  ...
  def getAPIGroup()(implicit apiKey: ApiKeyValue
    ...
    ApiRequest[V1APIGroup](ApiMethods.GET, baseUrl, "/apis/certificates.k8s.io/", "application/json")
